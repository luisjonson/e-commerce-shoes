  ...
  return (
    <HomeStaled>
      {produtos.length > 0 && (
        ...
        >
          {produtos
            .filter((produto) => produto.queimaEstoque)
            .map((produto) => (
      ...
      {produtos.length > 0 && (
        <section className="section-destaque">
          ...
          <ul>
            {produtos
              .filter((prod) => prod.queimaEstoque === true)
              .slice(0, 3)
              .map((produto) => (
                <div key={produto.numsequencial}>
                  <Card_oferta
                    oferta={produto.preco}
                    img={produto.linkImagem}
                    alt={produto.titulo}
                  />
                </div>
              ))}
              ...
              <div key={produto.numsequencial}>
                <CardProduto
                  desconto={
                    ...
                    porcentagemDesconto(produto.preco, produto.precoPromocional)
                  }
